...
export type OpenRemoteStatus = { instanceId: string; activeSessionIds: string[]; allowNewSessions?: boolean; connected: boolean; heartbeatTimeoutSeconds?: number; lastHeartbeatAt: number };
